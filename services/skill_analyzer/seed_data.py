"""Скрипт для заполнения начальных данных (seed) в базе.

Используется при запуске сервиса для того, чтобы в БД уже были
несколько навыков с привязанными к ним курсами.
"""
